...
// If user selected custom option, FOODS.length is used — ensure safe default
function App() {
  const [safeIndex, setSafeIndex] = useState(0);
  return <ProteinTester />;
}

ReactDOM.createRoot(document.getElementById('protein-root')).render(<App />);
